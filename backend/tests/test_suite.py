...
from app.models import Base, News, User
...
class TestValidators:
    ...
    def test_url_validation(self):
        ...
        assert Validators.is_valid_url("http://example.com/path")
        assert not Validators.is_valid_url("invalid")

    def test_hour_validation(self):
        """Test hour range validation."""
        from app.utils.validators import Validators

        assert Validators.is_valid_hour(8)
        assert Validators.is_valid_hour(0)
        assert Validators.is_valid_hour(23)
        assert not Validators.is_valid_hour(24)
        assert not Validators.is_valid_hour(-1)
...
class TestTextHelpers:
    ...
    def test_truncate(self):
        ...
        from app.utils.validators import TextHelpers
