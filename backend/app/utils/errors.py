...
class NewsAggregatorError(AggregatorError):
...
class ProcessingError(AggregatorError):
...
class EmailError(AggregatorError):
    """Email sending error."""
...
class SchedulerError(AggregatorError):
    """Scheduler error."""
    pass
...
class ErrorHandler:
    ...
    @staticmethod
    def handle_fetch_error(error: Exception, source: str) -> Any | None:
