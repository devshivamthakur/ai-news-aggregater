...
from app.fetchers.models import WebContent
...
class WebScraper:
    ...
    def fetch_content(self, url: str, source_name: str = "Web") -> WebContent | None:
...
def fetch_web_content(url: str, source_name: str = "Web") -> WebContent | None:
    """Fetch content from a web URL."""
    return web_scraper.fetch_content(url, source_name)

def fetch_medium_post(url: str) -> WebContent | None:
    """Fetch a Medium blog post."""
    return web_scraper.fetch_content(url, "Medium")

def fetch_website_content(url: str) -> WebContent | None:
