...
DEFAULT_MEDIUM_SOURCES: list[tuple[str, str]] = [
    ...
    ("https://medium.com/feed/@dev_shivam_thakur", "Dev Shivam Thakur"),
    # The following handles returned 404/403 and appear to be dead or incorrect.
    # Re-add with verified handles if desired:
